...
- [ ] output/md/md.go の makeTableTemplateData メソッド拡張
- [ ] テンプレートに渡すデータ構造の動的変更機能実装
- [ ] 論理名をテンプレートデータに組み込む処理実装
- [ ] カスタム列順序をテンプレートデータに反映する処理実装
- [ ] エイリアス適用をテンプレートデータに反映する処理実装
- [ ] 既存テンプレートとの互換性確保
